...
function calculateCircleArea(radius) {
  if (typeof radius !== "number") {
    console.log ("Помилка: 'radius' не є числом");
     return null
  };
...
let fraction = num - number;
return parseFloat(fraction.toFixed(5))
...
function isTotalPriceExceedsMaxPrice(products, maxPrice) {
  if (!Array.isArray(products)) {
    ...
    if (typeof maxPrice !== "number") {
      console.log("Помилка: аргумент має бути числoм.");
   return null;
  };
  let totalPrice = products.reduce((accumul, {price}) => 
    accumul + price, 0);
